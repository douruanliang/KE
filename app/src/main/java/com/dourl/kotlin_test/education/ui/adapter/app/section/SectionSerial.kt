 ...
 *
 */
class SectionSerial(list: List<SelectionBean.Data.Serial>?) : StatelessSection<SelectionBean.Data.Serial>(
    R.layout.layout_item_section_head, R.layout.layout_item_serial_body, list) {
