 ...
 *
 */
class SectionSpecial(list: List<SelectionBean.Data.Zhuanlan>?) : StatelessSection<SelectionBean.Data.Zhuanlan>(
    R.layout.layout_item_section_head, R.layout.layout_item_special_body, list) {
