...
import com.dourl.kotlin_test.education.utils.EmptyUtils
import com.dourl.kotlin_test.education.widget.CircleImageView
 ...
 *
 */
class SectionCourse(list: List<SelectionBean.Data.Course>?) : StatelessSection<SelectionBean.Data.Course>(
    R.layout.layout_item_section_head, R.layout.layout_item_section_footer, R.layout.layout_item_course_body, list) {
